...
import org.tmarciniak.cfmtp.web.config.ApplicationInitializer;
import org.tmarciniak.cfmtp.web.config.WebConfig;
import org.tmarciniak.cfmtp.web.websocket.TradeMessageWebSocketService;
import org.tmarciniak.cfmtp.web.websocket.support.client.StompMessageHandler;
import org.tmarciniak.cfmtp.web.websocket.support.client.StompSession;
import org.tmarciniak.cfmtp.web.websocket.support.client.WebSocketStompClient;
import org.tmarciniak.cfmtp.web.websocket.support.server.DispatcherServletInitializer;
import org.tmarciniak.cfmtp.web.websocket.support.server.TomcatWebSocketTestServer;
...
public class WebSocketTests extends TestCase {
	...
	public void testMessageQueue() throws Exception {
		...
		URI uri = new URI("ws://localhost:" + this.port + "/cfmtpws");
	...
	static class TestWebSocketConfig extends
		...
		public void registerStompEndpoints(StompEndpointRegistry registry) {
			...
			registry.addEndpoint("/cfmtpws").setHandshakeHandler(handler)
					.withSockJS();
		}
